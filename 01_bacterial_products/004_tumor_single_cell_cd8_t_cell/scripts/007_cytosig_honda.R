...
pseudobulk_data <- read_h5ad(
  "/data/scratch/kvalem/projects/2021/honda_microbial_metabolites_2021/20_scripts/40_single-cell-sorted-cd8/40_gex_surface_prot/28012026/pdata_cytosig_with_cycling.h5ad"
)
...
group_map <- c(
  "GF_noICI1_all" = "GF_noICI",
  "GF_noICI2_all" = "GF_noICI",
  "GF1_all"       = "GF",
  "GF2_all"       = "GF",
  "ctrl1_all"     = "ctrl",
  "ctrl2_all"     = "ctrl",
...
annotation_col <- data.frame(
  Group = factor(
    colnames(cs_avg),
    levels = c("GF_noICI", "GF", "ctrl", "effector")
  )
)
